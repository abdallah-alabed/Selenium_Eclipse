...
import testing.JUnitPet;

public class JUnitPet {
...
//			OwnerPet();
	...
	public String[] Vetranians() {
		...
		String namelist[] = new String[rows.size()] ;
...
//		This method is used to find the owners list from the website 
	...
	public String[] OwnerPet() {
		...
		return new String[] {FullName ,AddressName, CityName,TelephoneNumber,PetName,PetBirth,PetType};
	}

	
	public static void main(String[] args) {
		JUnitPet myObj = new JUnitPet();
		myObj.invokeBrowser();
